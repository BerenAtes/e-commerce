...
export function IconFacebookSquare({ className }) {
  return (
    <Icon
      classesDefault="fa-brands fa-square-facebook"
      classNameFromArgument={className}
    />
  );
}
...
export function IconLinkedIn({ className }) {
  return (
    <Icon
      classesDefault="fa-brands fa-linkedin"
      classNameFromArgument={className}
    />
  );
}
...
export function IconPhone({ className }) {
  return (
    <Icon
      classesDefault="fa-solid fa-phone"
      classNameFromArgument={className}
    />
  );
}
...
export function IconLocationDot({ className }) {
  return (
    <Icon
      classesDefault="fa-solid fa-location-dot"
      classNameFromArgument={className}
    />
  );
}
...
export function IconEnvelope({ className }) {
  return (
    <Icon
      classesDefault="fa-solid fa-envelope"
      classNameFromArgument={className}
    />
  );
}
